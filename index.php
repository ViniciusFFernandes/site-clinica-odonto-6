...
$ldjson = json_encode([
  ...
  '@graph' => [[
    ...
    'address' => [
      '@type' => 'PostalAddress',
      'streetAddress' => 'Rua Exemplo, 000, Sala 00 - Edifício Exemplo',
...
<head>
  ...
  <meta name="theme-color" content="#07ADF6" />
  <link rel="canonical" href="/" />
  <link rel="icon" href="favicon.ico" sizes="48x48" />

  <!-- Open Graph -->
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Clínica Odontológica Modelo" />
  ...
  <main id="topo">
      ...
      <div class="relative mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <div class="reveal">
          <span class="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-background px-4 py-2 text-xs font-semibold tracking-wide text-primary uppercase">
            ...
            <?= e($cfg['rating']) ?> de avaliação · Pacientes satisfeitos
          </span>
          ...
          <div class="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="#tratamentos" class="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-background px-7 py-4 text-base font-semibold text-primary transition-colors hover:bg-secondary">
              <?= icon('arrow-right', 'size-5') ?>Conhecer os tratamentos
            </a>
          </div>

          <div class="mt-8 flex items-center gap-3">
            <div class="flex gap-1 text-gold"><?php for ($k=0;$k<5;$k++) echo icon('star','size-5 fill-gold'); ?></div>
            <span class="text-sm text-muted-foreground"><strong class="text-primary"><?= e($cfg['rating']) ?> de avaliação</strong> · Pacientes satisfeitos</span>
          </div>
        </div>
        ...
        <div class="reveal relative" style="transition-delay:120ms">
          <div class="relative overflow-hidden rounded-[2.5rem] shadow-[var(--shadow-lift)]">
            <img src="img/hero-dentista.svg" alt="Dr(a). Nome Sobrenome atendendo uma paciente em seu consultório em Cidade Exemplo" width="1200" height="1408" class="h-full w-full object-cover" />
          </div>
    ...
    <section id="diferenciais" class="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
      <div class="reveal mx-auto max-w-2xl text-center">
        <span class="text-sm font-semibold tracking-widest text-gold uppercase">Diferenciais</span>
        <h2 class="mt-3 font-display text-4xl font-bold tracking-tight text-primary sm:text-5xl">Por que escolher a Dr(a). Nome Sobrenome</h2>
        <p class="mt-4 text-lg text-muted-foreground">Uma experiência pensada em cada detalhe para o seu conforto, segurança e confiança.</p>
      </div>

      <div class="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <?php foreach ($cfg['diferenciais'] as $i => $r): ?>
          <div class="reveal" style="transition-delay:<?= ($i % 3) * 90 ?>ms">
            <article class="surface-card flex h-full items-start gap-4 p-7">
              <span class="grid size-12 shrink-0 place-items-center rounded-2xl bg-accent-soft text-accent"><?= icon($r['icon'], 'size-6') ?></span>
              <span class="min-w-0">
                <h3 class="font-display text-xl font-semibold text-primary"><?= e($r['title']) ?></h3>
                <p class="mt-2 text-sm leading-relaxed text-muted-foreground"><?= e($r['desc']) ?></p>
              </span>
            </article>
          </div>
        <?php endforeach; ?>
    ...
    <!-- Tratamentos -->
    <section id="tratamentos" class="bg-secondary/60 py-20 lg:py-28">
      ...
      <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div class="reveal">
          <div class="overflow-hidden rounded-[2.5rem] shadow-[var(--shadow-lift)]">
            <img src="img/clinica-interior.svg" alt="Consultório da Dr(a). Nome Sobrenome em Cidade Exemplo" loading="lazy" width="1200" height="912" class="h-full w-full object-cover" />
          </div>
        </div>
    ...
    <!-- Como funciona -->
    <section class="bg-secondary/60 py-20 lg:py-28">
      <div class="mx-auto max-w-7xl px-5 lg:px-8">
        <div class="reveal mx-auto max-w-2xl text-center">
        ...
        <div class="mt-14 grid gap-6 lg:grid-cols-3">
          <?php foreach ($cfg['passos'] as $i => $s): ?>
            <div class="reveal" style="transition-delay:<?= $i * 110 ?>ms">
              <div class="relative h-full overflow-hidden rounded-[2rem] border border-border bg-card p-8 shadow-[var(--shadow-soft)]">
    ...
    <section id="depoimentos" class="bg-secondary/60 py-20 lg:py-28">
      <div class="mx-auto max-w-7xl px-5 lg:px-8">
        <div class="reveal mx-auto max-w-2xl text-center">
          ...
          <h2 class="mt-3 font-display text-4xl font-bold tracking-tight text-primary sm:text-5xl">O que dizem os pacientes</h2>
          <p class="mt-4 text-lg text-muted-foreground">Nota <?= e($cfg['rating']) ?> de 5. Histórias de quem já cuidou do sorriso com a Dr(a). Nome Sobrenome.</p>
        </div>
        ...
        <div class="reveal">
          ...
          <ul class="mt-8 space-y-5 text-sm">
            <li class="flex gap-3">
              ...
              <span class="text-muted-foreground">Edifício Exemplo<br />Rua Exemplo, 000 · Sala 00<br /><?= e($cfg['city']) ?> - <?= e($cfg['state']) ?></span>
            </li>
            <li class="flex gap-3">
  ...
  <footer class="border-t border-border bg-secondary/60">
    <div class="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
      <div>
        ...
        <p class="mt-3 text-sm leading-relaxed text-muted-foreground">Odontologia humanizada e de alto padrão em <?= e($cfg['city']) ?>. Atendimento com nota <?= e($cfg['rating']) ?>.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p class="mt-4 text-sm text-muted-foreground">Edifício Exemplo<br />Rua Exemplo, 000 · Sala 00<br /><?= e($cfg['city']) ?> - <?= e($cfg['state']) ?></p>
      ...
      <div>
        <h3 class="text-sm font-semibold text-primary">Agende agora</h3>
        <p class="mt-4 text-sm text-muted-foreground">Cuide do seu sorriso com um atendimento de excelência.</p>
    ...
    <div class="border-t border-border py-6 text-center text-xs text-muted-foreground">
      © <?= date('Y') ?> Clínica Odontológica Modelo. Todos os direitos reservados.
    </div>
  </footer>
